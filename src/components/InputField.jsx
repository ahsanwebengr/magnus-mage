...
const InputField = (props) => {
  ...
  return (
    <div className='mb-4 w-full relative'>
      ...
      <input type={isPassShow ? 'text' : type} placeholder={placeholder} onChange={onChange} className={`border border-gray p-2 w-full h-10 rounded-lg text-md font-normal focus:outline-primary px-10 text-primary-color ${styling}`} />
